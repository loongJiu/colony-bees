...
export async function createProofreader() {
  ...
  agent.onTask('proofreading', async (ctx) => {
    ...
    const prompt = loadPrompt(import.meta.url, 'proofread.md', { input: inputStr })
