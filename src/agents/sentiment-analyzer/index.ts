...
const AGENT_NAME = 'sentiment-analyzer'
...
export async function createSentimentAnalyzer() {
  ...
  agent.onTask('sentiment_analysis', async (ctx) => {
    ...
    const prompt = loadPrompt(import.meta.url, 'sentiment.md', { input: inputStr })
