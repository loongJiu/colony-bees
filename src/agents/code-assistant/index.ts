...
export async function createCodeAssistant() {
  logger.info('初始化开始')
  ...
  agent.onTask('code_assistance', async (ctx) => {
    ...
    const prompt = loadPrompt(import.meta.url, 'review.md', { input: inputStr })
